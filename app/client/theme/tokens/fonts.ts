...
export const fonts = defineTokens.fonts({
  heading: {
    value:
      '"Climate Crisis", "Mochiy Pop One", "Twemoji", -apple-system, BlinkMacSystemFont, "Segoe UI", Helvetica, Arial, sans-serif, "Apple Color Emoji", "Segoe UI Emoji", "Segoe UI Symbol"',
  },
  body: {
    value:
